...
public final class RSAUtils {
	...
	public static String sign(String data, String priKeyFilePath) throws Exception {
		PrivateKey privateKey = RSAKeyUtils.getPrivateKey(priKeyFilePath);
	...
	public static boolean verify(String srcData, String pubKeyFilePath, String sign) throws Exception {
		PublicKey publicKey = RSAKeyUtils.getPublicKey(pubKeyFilePath);
		Signature signature = Signature.getInstance("MD5withRSA");
